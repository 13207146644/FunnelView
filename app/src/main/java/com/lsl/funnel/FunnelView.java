...
public class FunnelView extends View {
    ...
    private void initData() {
        ...
        //图形距离上方偏移量
        dp3 = (int) getContext().getResources().getDimension(R.dimen.dp3);
        dp5 = (int) getContext().getResources().getDimension(R.dimen.dp5);
        dp10 = (int) getContext().getResources().getDimension(R.dimen.dp10);
        dp15 = (int) getContext().getResources().getDimension(R.dimen.dp15);
        dp20 = (int) getContext().getResources().getDimension(R.dimen.dp20);
        dp30 = (int) getContext().getResources().getDimension(R.dimen.dp30);
        dp40 = (int) getContext().getResources().getDimension(R.dimen.dp40);
        dp60 = (int) getContext().getResources().getDimension(R.dimen.dp60);
    }
